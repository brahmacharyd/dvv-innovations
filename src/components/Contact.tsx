  ...
  return (
    <section id="contact" className="py-24 bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        ...
        <div
          className="absolute bottom-40 right-10 w-56 h-56 bg-accent rounded-full blur-3xl animate-float"
      ...
      <div className="container mx-auto px-6 relative">
            ...
            <Card className="bg-gradient-card border-border/50 shadow-card hover:shadow-elegant transition-all duration-300">
              ...
              <CardContent className="space-y-6">
                ...
                <Button
                  variant="hero"
                  size="lg"
                  className="w-full shadow-glow hover:shadow-elegant hover:scale-105 transition-all duration-300 group"
                >
                  Send Message
        ...
        {/* Business Hours + Clients CTA Side by Side (Equal Height) */}
        <AnimatedSection animation="fade-in" delay={800}>
          <div className="mt-24 grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch">
            {/* Business Hours */}
            <Card className="flex flex-col justify-center bg-gradient-card border-border/50 shadow-card hover:shadow-elegant transition-all duration-300 group text-center h-full">
              <CardContent className="p-10 flex flex-col items-center justify-center h-full">
                <div className="w-20 h-20 bg-gradient-primary rounded-2xl flex items-center justify-center mb-6 group-hover:shadow-glow group-hover:scale-110 transition-all duration-300">
                  <Clock className="w-10 h-10 text-primary-foreground animate-float" />
                </div>
                ...
                <div className="space-y-1 text-muted-foreground text-lg">
                  ...
                  <p className="text-sm mt-2 text-primary">Response time: Within 24 hours</p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-10 flex flex-col items-center justify-center h-full">
                <div className="flex -space-x-3 mb-6">
                  {[1, 2, 3, 4].map((_, i) => (
                    <div
                      key={i}
                      className="w-12 h-12 bg-gradient-primary rounded-full border-4 border-background flex items-center justify-center"
                    >
